...
export class PointService {
  ...
  async chargePoint(userId: number, amount: number): Promise<UserPoint> {
    ...
    const chargedUserPoint: UserPoint = await this.userDb.insertOrUpdate(userId, updatedPoint);
  ...
  async usePoint(userId: number, amount: number): Promise<UserPoint> {
    ...
    const usedUserPoint: UserPoint = await this.userDb.insertOrUpdate(userId, updatedPoint);
